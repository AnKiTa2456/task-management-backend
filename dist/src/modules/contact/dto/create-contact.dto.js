...
class CreateContactDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, email: { required: true, type: () => String }, phone: { required: true, type: () => String }, message: { required: true, type: () => String, minLength: 5 }, notes: { required: false, type: () => String } };
    }
}
